        ...
        private static IHostBuilder CreateHostBuilder(string[] args)
        {
            return Host.CreateDefaultBuilder(args)
                .ConfigureServices((hostContext, services) =>
                {
                    ...
                    services.AddTransient<IQueueConsumer<LandQueueConsumer>, LandQueueConsumer>();
                    services.AddHostedService<AzureQueueConsumerBackgroundService<LandQueueConsumer>>();
                    services.AddSingleton<ILandQueueClient>(new LandQueueClient(mayhemConfiguration.MayhemConfiguration.ConnectionStringsConfigruation.AzureQueueLandConnectionString, QueueNames.LandQueue));
