...
namespace Mayhem.Explore.Mission.Worker.App
{
        ...
        public static IHostBuilder CreateHostBuilder(string[] args)
        {
            return Host.CreateDefaultBuilder(args)
                .ConfigureServices((hostContext, services) =>
                {
                    ...
                    services.AddHostedService<ExploreMissionBackgroundWorker>();

                    services.AddSingleton<IExploreMissionService, ExploreMissionService>();
                    services.AddSingleton<IExploreMissionRepository, ExploreMissionRepository>();
