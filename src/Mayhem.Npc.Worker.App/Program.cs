        ...
        public static IHostBuilder CreateHostBuilder(string[] args)
        {
            return Host.CreateDefaultBuilder(args)
                .ConfigureServices((hostContext, services) =>
                {
                    ...
                    services.AddHostedService<NpcTokenTransferBackgroundWorker>();
                    services.AddNpcQueuePublisher(mayhemConfiguration.MayhemConfiguration.ConnectionStringsConfigruation.AzureQueueNpcConnectionString);
