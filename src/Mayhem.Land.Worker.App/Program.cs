        ...
        public static IHostBuilder CreateHostBuilder(string[] args)
        {
            return Host.CreateDefaultBuilder(args)
                .ConfigureServices((hostContext, services) =>
                {
                    ...
                    services.AddHostedService<LandTokenTransferBackgroundWorker>();

                    services.AddLandQueuePublisher(mayhemConfiguration.MayhemConfiguration.ConnectionStringsConfigruation.AzureQueueLandConnectionString);
