...
{
    internal class DiscoverMissionIntegrationTests : BaseRepositoryTests
    {
        private IDiscoveryMissionService discoveryMissionService;

        [OneTimeSetUp]
        public void SetUp()
        {
            discoveryMissionService = new DiscoveryMissionService(
                GetDiscoveryMissionRepository(),
                GetUserLandRepository(),
                GetNpcRepository(),
                new Mock<ILogger<DiscoveryMissionService>>().Object);
        }
        ...
        public async Task CreateStruture_AddMissions_ThenAddUserLandAndRemoveMissions_Test()
        {
            using (IDbConnection db = new SqlConnection(ConnectionString))
            {
                ...
                string getMissions = "select * from mission.DiscoveryMission";
