...
namespace Mayhem.Notification.Consumer.App
{
        ...
        private static IHostBuilder CreateHostBuilder(string[] args)
        {
            return Host.CreateDefaultBuilder(args)
                .ConfigureServices((hostContext, services) =>
                {
                    ...
                    services.AddScoped<IInviteNotificationService, InviteNotificationService>();
                    ...
                    services.AddTransient<IQueueConsumer<NotificationQueueConsumer>, NotificationQueueConsumer>();
                    services.AddHostedService<AzureQueueConsumerBackgroundService<NotificationQueueConsumer>>();
                    services.AddSingleton<INotificationQueueClient>(new NotificationQueueClient(mayhemConfiguration.MayhemConfiguration.ConnectionStringsConfigruation.AzureQueueNotificationConnectionString, QueueNames.NotificationQueue));
