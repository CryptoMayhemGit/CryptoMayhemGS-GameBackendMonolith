...
namespace Mayhem.Dal.Migrations
{
    ...
    [Migration("20220811074120_SettingMigration")]
    partial class SettingMigration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mayhem.Dal.Tables.Dictionaries.NpcStatus", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
                    ...
                    b.ToTable("NpcStatus", "dictionary");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 3,
                            Name = "OnExploreMission"
                        },
                        new
                        {
                            Id = 4,
                            Name = "OnDiscoveryMission"
                        });
                });
            ...
            modelBuilder.Entity("Mayhem.Dal.Tables.Settings.Setting", b =>
                {
            ...
            modelBuilder.Entity("Mayhem.Dal.Tables.Nfts.Npc", b =>
                {
                    ...
                    b.HasOne("Mayhem.Dal.Tables.Dictionaries.NpcStatus", "NpcStatus")
                        .WithMany("Npcs")
                        .HasForeignKey("NpcStatusId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
