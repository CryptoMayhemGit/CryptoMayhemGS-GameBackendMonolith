...
namespace Mayhem.Dal.Contexts
{
    /// <summary>
    /// DbContext mainly used in rest api
    /// </summary>
    public class MayhemDataContext : IdentityDbContext<ApplicationUser>, IMayhemDataContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                MayhemConfigurationService mayhemConfiguration = new(new MayhemConfigurationBuilder(Environment.GetEnvironmentVariable(EnviromentVariables.MayhemAzureAppConfigurationConnecitonString), Environment.GetEnvironmentVariable(EnviromentVariables.MayhemConfigurationType)).GetSection<MayhemConfiguration>());
                optionsBuilder.UseSqlServer(mayhemConfiguration.MayhemConfiguration.ConnectionStringsConfigruation.MSSQLConnectionString);
            }
        }
    }
}
